    ...
    <div className="min-h-screen bg-slate-100 px-4 py-8">
      <div className="max-w-7xl mx-auto">
        ...
        {adminTab === 'accounts' ? (
          ...
          <AdminEnquiriesSection
            adminKey={adminKey}
            onAuthError={handleAdminAuthError}
            setToast={setToast}
            onCompanyCreated={loadOverview}
          />
        ) : (
          <>
                      ...
                      >
                        <td className="px-4 py-2.5">
                          ...
                          <div className="mt-1 flex flex-wrap items-center gap-1.5">
                            ...
                            {c.source_lead_id != null && (
                              <span className="inline-flex rounded-full border border-violet-200 bg-violet-50 px-2 py-0.5 text-[10px] font-medium text-violet-800">
