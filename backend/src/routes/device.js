...
router.patch('/:id/adms-serial', withDeviceAuth, requireHrBranchForMutation, updateAdmsSerialHandler);
router.delete('/:id', withDeviceAuth, requireHrBranchForMutation, deleteDeviceHandler);
